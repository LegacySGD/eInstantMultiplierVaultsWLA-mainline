...
public class MultiplierVaultsWLAEngineManagerTest
{
	...
	{
		logger = Logger.getLogger(MultiplierVaultsWLAEngineManagerTest.class);
		gameParams = XMLUtil.parseResource("paymodel/MultiplierVaultsWLAIW/GameParams.xml").getDocumentElement();
		previousOutcome = XMLUtil.parseResource("paymodel/MultiplierVaultsWLAIW/InitOutcome.xml").getDocumentElement();
